...
- Claude, Codex, Kimi, CodeBuddy, Gemini, Qwen, GitHub Copilot, Cursor, OpenCode, Z.ai and DeepSeek icons derive from LobeHub Icons (MIT). The full notice and source revision are in `src/renderer/assets/LICENSE-LobeHub.txt`.
